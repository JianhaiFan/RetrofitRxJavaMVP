...
import com.xiaofan.retrofitrxjavamvp.download.DownState;
import com.xiaofan.retrofitrxjavamvp.download.HttpDownManager;
import com.xiaofan.retrofitrxjavamvp.download.downloadListener.DownloadProgressListener;
import com.xiaofan.retrofitrxjavamvp.listener.HttpDownOnNextListener;
import com.xiaofan.retrofitrxjavamvp.utils.DbDownUtil;
...
/**
 * @author: 范建海
 * @createTime: 2017/3/28 10:48
 * @className:  ProgressDownSubscriber
 * @description: 断点下载处理类Subscriber，用于在Http请求开始时，自动显示一个ProgressDialog，在Http请求结束是，关闭ProgressDialog，调用者自己对请求数据进行处理
 * @changed by:
 */
